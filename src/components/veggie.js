    ...
    <div className="Veggie col-4">
      <div className="card">
        ...
        <div className="card-body">
          ...
          <p className="card-text">You trying to be healthy but you still can't resist pizza? Well then the veggie slice is for you! This guilt-free pizza at it's finest.</p>
        </div>
